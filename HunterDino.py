# Hunter's Meal (a 2D Multiplayer Game)
# Developers : Abdul Mohsin Siddiqi and Anish Sharma
...
NUMSQUIRRELS = 30    # number of creatures in the active area
SQUIRRELMINSPEED = 3 # slowest creature speed
SQUIRRELMAXSPEED = 7 # fastest creature speed
...
def main():
    ...
    pygame.display.set_caption("HunterDino")
    BASICFONT = pygame.font.Font('freesansbold.ttf', 32)

    # load the image files
    L_IMG = [pygame.image.load('dn.png'),pygame.image.load('dn1.png'),pygame.image.load('dn2.png'),pygame.image.load('dn3.png')]
...
def runGame():
    ...
    winSurf = BASICFONT.render('You have reached Maximum size!', True, WHITE)
